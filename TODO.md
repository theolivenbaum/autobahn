...
- [ ] **Replace the handwritten HTML report** with output generated by the same UI components
  ...
  codebase for both. *Blocked on section 8: there are no UI components to generate it with
  yet. Until then the handwritten template carries the metrics and thresholds tables.*
